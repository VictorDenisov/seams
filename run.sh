...
export JP_INPUT_PATH=/home/victor/aspirantura/sample_projects/tomcat/java
...
java -cp `find /home/victor/aspirantura/sample_projects/tomcat/output/jars -name *.jar|sed -e :a -e "N;s/\n/:/; ta"` -jar target/seams-0.1.jar \
org.creativelabs.MainApp -d -f $JP_INPUT_PATH
