...
export JP_INPUT_PATH=../sample_projects/jtags_0.7
...
java -cp target/seams-0.1.jar:../sample_projects/jtags_0.7/jtags.jar org.creativelabs.MainApp -d -f $JP_INPUT_PATH
